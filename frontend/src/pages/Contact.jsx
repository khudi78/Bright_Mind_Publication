...
export default function Contact() {
  return (
     <>
          ...
          <div className='flex flex-row max-w-5xl mx-auto gap-20 mt-20 mb-20 py-10 shadow-2xl shadow-gray-600 p-7 bg-gray-200 '>
            <div className='flex flex-col gap-5 w-[400px]'>
                <div className='text-3xl font-bold '>Reach Out to Us</div>
                <div>
                ...
                <div className='flex flex-col w-[350px] ml-13 gap-3 p-4  bg-neutral-200 border-gray-800 border-1 py-7 mt-7 rounded-sm shadow-gray-800'>
            ...
            <div className='w-[2px] h-[550px] rounded-sm bg-gradient-to-b from-gray-400 to-gray-900'></div>
            <div>
                <div className='text-3xl font-bold mb-7'>Send us a message</div>
                <ContactForm />
            </div>
          </div>
